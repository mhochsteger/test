...
require.config({ paths: {
  ...
  dat: "https://cdnjs.cloudflare.com/ajax/libs/dat-gui/0.7.6/dat.gui.js"
}});

require.undef('ngsolve_webgui');
console.log("define", define);
define('ngsolve_webgui', ["THREE","@jupyter-widgets/base"], function (THREE, widgets) {
 ...
 */
  ...
  let exports = {};
  console.log("build data module");
function exportDat(exports) {
